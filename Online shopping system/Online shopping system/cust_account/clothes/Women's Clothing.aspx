<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Women's Clothing.aspx.cs" Inherits="Online_shopping_system.cust_account.clothes.Women_s_Clothing" %>
...
<nav class="navbar glyphicon-text-color">
  ...
  <div class="row" style="width:1040px">
     <div class="panel panel-warning">
        <div class="panel-heading">Women's Cloth..</div>
            ...
            <div id="myCarousel" class="carousel slide"  data-wrap="false">
                <div class="carousel-inner" role="listbox">
                    <div class="item active"  id="carousel" >
                        <div class="col-sm-4">
                <a href="/cust_account/display.aspx?id=38">
                    <img src="../../images/clothes/women/61icGPJ0kbL._UL1500_.jpg"  style="cursor:pointer; width:100%; height:250px "alt="Image" />
                    <div><asp:Label ID="Label9" runat="server" Text="cloth_1"></asp:Label></div>
