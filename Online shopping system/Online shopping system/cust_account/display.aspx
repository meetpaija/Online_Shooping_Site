<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="display.aspx.cs" Inherits="Online_shopping_system.cust_account.display" %>
...
<head>
  ...
  <script>
    ...
    <script  type = "text/javascript" >
        function getimage(){
            return "../images/sports/cricket/bat/bat_1_1.jpg"
        }
...
.image{
    cursor:pointer; width:100%; height:350px ;
}
  ...
  <div class="container-fluid">
     ...
     <ul class="nav navbar-nav navbar-right">
      <li class="active"><a href="../customer/validate.aspx" class="a1" ><span class="glyphicon glyphicon-home"></span> Home</a></li>
            <li class="dropdown mega-dropdown">
			   <a href="#" class="dropdown-toggle a1"  data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i> <asp:Label ID="Label5" runat="server" Text=""></asp:Label> Account <i class="caret"></i></a>				
    ...
    padding-left: 0px;">
         ...
         <div class="w3-container w3-center">
             <asp:Label ID="Label12" CssClass="w3-text-red w3-large w3-center" runat="server" Text=""></asp:Label>
         </div>
         <div class="w3-container">
             <div class="w3-container">
                 <ul class="breadcrumb">
                  <li><a href="../customer/validate.aspx">Home</a></li>
                  <li><a id="connect" runat="server" onserverclick="connect2">
             ...
             <div class="w3-row-padding">
                 <div class=" w3-half ">
                     <div class=" w3-card-2 col-sm-5">
                     <div class="w3-container ">
                         <a class=" w3-center"  >
                             <asp:Image ID="Image1" CssClass="image" AlternateText="Image"  runat="server" /></a><hr />
                            <div class="w3-row-padding">
                                <div class="w3-container">
                                    <asp:ImageButton ID="ImageButton1" CssClass="image1 img-thumbnail active"  runat="server" OnClick="ImageButton1_Click1" />
                                   <asp:ImageButton ID="ImageButton2" CssClass="image1 img-thumbnail"  OnClick="ImageButton2_Click" runat="server" />
                                   <asp:ImageButton ID="ImageButton3" CssClass="image1 img-thumbnail"  OnClick="ImageButton3_Click" runat="server" />
                 ...
                 <div class="w3-half a5">
                     <div class="w3-container w3-card-2">
                         <div class="w3-container">
                             <br />
                         <asp:Label ID="Label3" CssClass="w3-xxlarge w3-text-blue" runat="server" Text=""></asp:Label>
                             <hr />
                         </div>
                         <div class="w3-container">
                             <ul>
                            <li class="w3-large"> Price: <s><span class="w3-text-red">₹</span> <asp:Label ID="Label4" CssClass="w3-text-red" runat="server" Text=""></asp:Label></s></li>
                            <li class="w3-large"> Sale: <span class="w3-text-red">₹</span> <asp:Label ID="Label6" CssClass="w3-text-red"  runat="server" Text=""></asp:Label></li>
                            <li class="w3-large"> You Save: <span class="w3-text-red">₹</span> <asp:Label ID="Label7" CssClass="w3-text-red"  runat="server" Text=""></asp:Label></li>
                                 </ul>
                             <p class=" w3-xlarge">Only cash on delivery is avilable...</p>
                             <hr />
                         </div>
                         <div class="w3-container">
                             <p class="w3-large w3-text-blue"> Description:</p>
                             <ul > 
                                 <li class="w3-large"> <asp:Label ID="Label8" runat="server" Text=""></asp:Label></li>
                                 </ul>
                                 <p class="w3-large"> <asp:Label ID="Label9" Visible="false" runat="server" Text=""></asp:Label></p>
                                 
                             
                             <p class="w3-large w3-center"> <asp:Label ID="Label10" CssClass="w3-text-red" Visible="false" runat="server" Text=""></asp:Label></p>
                             <p class="w3-large"><asp:Label ID="Label11" CssClass="w3-text-blue"  Visible="false" runat="server" Text=""></asp:Label><asp:TextBox Visible="false" Text="1" BorderStyle="Ridge"  CssClass="w3-form " Width="100" ID="TextBox1" TextMode="Number" runat="server"></asp:TextBox>
                            <asp:RangeValidator id="ValQty" 
                                        Type="Integer"
                                        Display="Dynamic" 
                                        ForeColor="Red"
                                        Text="These products are not in range.."
                             ...
                             <div class="form-horizontal"> 
                                 <div class="form-group">
                                   <div class="col-sm-offset-2 col-sm-4">
                                    <asp:Button ID="Button1" Visible="false" CssClass=" w3-btn w3-light-blue w3-hover-blue  w3-round-xxlarge" OnClick="Button1_Click" runat="server" Text="Buy Now"  />
                                    </div>
                                   <div class="col-sm-offset-1 col-sm-4">
                                    <asp:Button ID="Button2" Visible="false" CssClass=" w3-btn w3-light-blue w3-hover-blue w3-round-xxlarge" OnClick="Button2_Click" runat="server" Text="Add To Cart" />
                                </div>
                             </div>
                         </div>
                     </div>
