<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Luggage.aspx.cs" Inherits="Online_shopping_system.cust_account.bags.Luggage" %>
...
<nav class="navbar glyphicon-text-color">
  ...
  <div class="row" style="width:1040px">
     <div class="panel panel-warning">
        <div class="panel-heading">For Traelling..</div>
            ...
            <div id="myCarousel" class="carousel slide"  data-wrap="false">
                <div class="carousel-inner" role="listbox">
                    <div class="item active"  id="carousel" >
                        <div class="col-sm-4">
                <a href="/cust_account/display.aspx?id=29">
                    <img src="../../images/bags/luggege/91fbSPLPYOL._SL1500_.jpg" style="cursor:pointer; width:100%; height:250px "alt="Image" />
                    <div><asp:Label ID="Label9" runat="server" Text="Luggege_2"></asp:Label></div>
