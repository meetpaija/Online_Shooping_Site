<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yourcart.aspx.cs" Inherits="Online_shopping_system.cust_account.yourcart" %>
         ...
         <div class="w3-row-padding">
             <div class="w3-card-2">
                 <div class="w3-container">
                     <p class="w3-xxlarge w3-text-blue">Your Cart.. </p><hr />
                     
                 </div>
                 <div class="w3-container">
                     <asp:GridView ID="GridView1" CssClass = "Grid w3-table w3-bordered" runat="server" OnRowDeleting="OnRowDeleting" AutoGenerateColumns = "false" OnRowDataBound = "OnRowDataBound">
                        <Columns>
                            ...
                            <asp:CommandField ShowDeleteButton="True" ButtonType="Button" ControlStyle-CssClass="w3-btn" />
                        </Columns>
                    </asp:GridView>
