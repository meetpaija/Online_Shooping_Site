<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Laptop and Accessories.aspx.cs" Inherits="Online_shopping_system.cust_account.electronics.Laptop_and_Accessories" %>

<!DOCTYPE html>

<html lang="en">
<head>
  <title>Laptop and Accessories</title>
  <meta charset="utf-8">
...
<nav class="navbar glyphicon-text-color">
  ...
  <div class="row" style="width:1040px">
     <div class="panel panel-warning">
        <div class="panel-heading">Apple Laptop</div>
