<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PC Accessories.aspx.cs" Inherits="Online_shopping_system.cust_account.electronics.PC_Accessories" %>
...
<nav class="navbar glyphicon-text-color">
  ...
  <div class="row" style="width:1040px">
     <div class="panel panel-warning">
        <div class="panel-heading">Key-Boards..</div>
            ...
            <div id="myCarousel" class="carousel slide"  data-wrap="false">
                <div class="carousel-inner" role="listbox">
                    <div class="item active"  id="carousel" >
                        <div class="col-sm-4">
                <a href="/cust_account/display.aspx?id=24">
                    <img src="../../images/electronics/pc%20accessories/7179nZqAblL._SL1500_.jpg"   style="cursor:pointer; width:100%; height:250px "alt="Image" />
                    <div><asp:Label ID="Label9" runat="server" Text="Keyboard & Mouse"></asp:Label></div>
