<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Printers and Scanners.aspx.cs" Inherits="Online_shopping_system.cust_account.electronics.Printers_and_Scanners" %>
            ...
            <div id="myCarousel" class="carousel slide"  data-wrap="false">
                <div class="carousel-inner" role="listbox">
                    <div class="item active"  id="carousel" >
                        ...
                        <div class="col-sm-4">
                <a href="/cust_account/display.aspx?id=21">
                    <img src="../../images/electronics/printers/81CO5Iqt7FL._SL1500_.jpg" style="cursor:pointer; width:100%; height:250px "alt="Image" />
                    <div><asp:Label ID="Label9" runat="server" Text="Printer"></asp:Label></div>
