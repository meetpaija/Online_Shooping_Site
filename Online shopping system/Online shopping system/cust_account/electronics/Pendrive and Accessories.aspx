<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pendrive and Accessories.aspx.cs" Inherits="Online_shopping_system.cust_account.electronics.Pendrive_and_Accessories" %>

<!DOCTYPE html>

<html lang="en">
<head>
  <title>Pendrive and Accessories</title>
  <meta charset="utf-8">
...
<nav class="navbar glyphicon-text-color">
    ...
    padding-left: 0px;">
          ...
          <div class="w3-container">
                 <ul class="breadcrumb">
                  ...
                  <li>Pendrive and Accessories</li>
                </ul>
             </div>
         <div class="w3-container">
  ...
  <div class="row" style="width:1040px">
     <div class="panel panel-warning">
        <div class="panel-heading">Sanddisk Pendrive</div>
