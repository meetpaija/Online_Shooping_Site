<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Network Accessories.aspx.cs" Inherits="Online_shopping_system.cust_account.electronics.Network_Accessories" %>
            ...
            <div id="myCarousel" class="carousel slide"  data-wrap="false">
                <div class="carousel-inner" role="listbox">
                    <div class="item active"  id="carousel" >
                        ...
                        <div class="col-sm-4">
                <a href="/cust_account/display.aspx?id=23">
                    <img src="../../images/electronics/internet/61dyE-+pAUL._SL1295_.jpg"  style="cursor:pointer; width:100%; height:250px "alt="Image" />
                    <div><asp:Label ID="Label9" runat="server" Text="Router_1"></asp:Label></div>
