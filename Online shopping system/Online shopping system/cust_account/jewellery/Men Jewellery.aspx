<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Men Jewellery.aspx.cs" Inherits="Online_shopping_system.cust_account.jewellery.Men_Jewellery" %>

<!DOCTYPE html>

<html lang="en">
<head>
  <title>Men Jewellery</title>
  <meta charset="utf-8">
...
<nav class="navbar glyphicon-text-color">
  ...
  <div class="row" style="width:1040px">
     <div class="panel panel-warning">
        <div class="panel-heading">Chains..</div>
            ...
            <div id="myCarousel" class="carousel slide"  data-wrap="false">
                <div class="carousel-inner" role="listbox">
                    <div class="item active"  id="carousel" >
                        <div class="col-sm-4">
                <a href="/cust_account/display.aspx?id=26">
                    <img src="../../images/jewellery/men/61niW17wWiL._UL1500_.jpg"   style="cursor:pointer; width:100%; height:250px "alt="Image" />
                    <div><asp:Label ID="Label9" runat="server" Text="chain_1"></asp:Label></div>
