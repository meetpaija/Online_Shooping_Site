<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="delivery_info.aspx.cs" Inherits="Online_shopping_system.cust_account.delivery_info" %>
             ...
             <div class="w3-half">
                 <div class="w3-card-2">
                     <div class="w3-container">
                         <p class="w3-xlarge w3-text-blue">Track Your Product..</p><hr />

                     </div>
                     <div class="w3-container">
                         <asp:GridView ID="GridView1" AutoGenerateSelectButton="true"  CssClass="w3-table w3-bordered"  OnSelectedIndexChanging="GridView1_SelectedIndexChanging" runat="server">
             ...
             <div class="w3-half">
                 ...
                 <div class="form-horizontal">
                     <div class="form-group " style="margin-left:30px;">
                         <asp:Label Class="control-label w3-large" ID="lab" Visible="false" runat="server" ><span class="glyphicon glyphicon-hand-right w3-text-blue"></span> Delivery Date:</asp:Label>
                          <asp:Label ID="Label2" CssClass="control-label w3-large" Visible="false"  runat="server" Text=""></asp:Label>
                          </div>
                     <div class="form-group " style="margin-left:30px;">
                         <asp:Label Class="control-label w3-large" ID="Label3" Visible="false" runat="server" ><span class="glyphicon glyphicon-hand-right w3-text-blue"></span> Delivery Status:</asp:Label>
                          <asp:Label ID="Label4" CssClass="control-label w3-large" Visible="false"  runat="server" Text=""></asp:Label>
                          </div>
                 </div>
             </div>
         </div>
