<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment_order.aspx.cs" Inherits="Online_shopping_system.customer.payment_order" %>
         ...
         <div class="w3-row-padding">
             <div class="w3-card-2">
                 <div class="w3-container">
                     <p class="w3-xxlarge w3-text-blue">Congratulations...</p><hr />
                 </div>
                     ...
                     <div class="form-horizontal">
                         ...
                         <asp:Label Class="control-label w3-xlarge w3-text-blue " runat="server" >Delivery info..</asp:Label>

                          </div>
                         <div class="form-group " style="margin-left:30px;">
                         <asp:Label Class="control-label w3-large" runat="server" >Your Order has been successfully placed.</asp:Label>
                             <hr />
                          </div>
                         <div class="w3-container">
                             <div class="form-group">
                            <asp:Button ID="Button5" CssClass=" w3-btn w3-light-blue w3-hover-blue w3-round-large col-sm-offset-4 col-sm-6" runat="server" Text="See Delivery Info.." OnClick="Button5_Click" />
                        </div>
                         </div>
