<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cust_delivery.aspx.cs" Inherits="Online_shopping_system.customer.cust_delivery" %>
         ...
         <div class="w3-row-padding">
             <div class="w3-card-2">
                 <div class="w3-container">
                     <p class="w3-xxlarge w3-text-blue">Delivery info..</p><hr />
                 </div>
                     ...
                     <div class="form-horizontal">
                         ...
                         <div class="form-group " style="margin-left:30px;">
                         <asp:Label Class="control-label w3-large" runat="server" ><span class="glyphicon glyphicon-hand-right w3-text-blue"></span>Total Amount: </asp:Label>
                          <asp:Label ID="Label4" CssClass="control-label w3-large"  runat="server" Text="Label"></asp:Label>
                          </div>
                         <div class="form-group" style="margin-left:30px;">
                         ...
                         <div class="form-group " style="margin-left:30px;">
                         <asp:Label Class="control-label w3-large"  runat="server" ><span class="glyphicon glyphicon-hand-right w3-text-blue"></span> Delivery Date:</asp:Label>
                          <asp:Label ID="Label8" CssClass="control-label w3-large"  runat="server" Text="Label"></asp:Label>
                          </div>
                         <div class="form-group " style="margin-left:30px;">
                         <asp:Label Class="control-label w3-large"  runat="server" ><span class="glyphicon glyphicon-hand-right w3-text-blue"></span> Shipping Address:</asp:Label>
                          <asp:Label ID="Label10" CssClass="control-label w3-large"  runat="server" Text="Label"></asp:Label>
                          </div>
                         <div class="form-group " style="margin-left:30px;">
                         <asp:Label Class="control-label w3-large" ID="Label5" Visible="false" runat="server" ><span class="glyphicon glyphicon-hand-right w3-text-blue"></span> Size:</asp:Label>
                          <asp:Label ID="Label6" CssClass="control-label w3-large" Visible="false"  runat="server" Text="Label"></asp:Label>
                          <hr /></div>
                         <div class="form-group " style="margin-left:30px;">
                         <asp:Label Class="control-label w3-large"  runat="server" ><span class="glyphicon glyphicon-hand-right w3-text-blue"></span> Give feedback:</asp:Label>
                             </div>
                         <p class="w3-text-red w3-center">
                             <asp:Label ID="Label9"  runat="server" Text=""></asp:Label></p>
                          <div class="form-group">
                                <label class="control-label col-sm-5">Feedback Message:</label>
                                <div class="col-sm-2">
                                  <asp:TextBox ID="TextBox8" TextMode="MultiLine" CssClass="form-control" Rows="4" Width="200" runat="server"></asp:TextBox>
                                 
                                </div> 
                        
                            <asp:Button ID="Button1" CssClass=" w3-btn w3-light-blue w3-hover-blue w3-round-large  col-sm-6" runat="server" Text="Submit" OnClick="Button1_Click"  />
                       </div>
                          <div class="form-group">
                            <asp:Button ID="Button5" CssClass=" w3-btn w3-light-blue w3-hover-blue w3-round-large col-sm-offset-5 col-sm-6" runat="server" Text="Continue Shopping" OnClick="Button5_Click"  />
                        </div>
